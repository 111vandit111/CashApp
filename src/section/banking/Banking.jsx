...
const Banking = () => {
  ...
  return (
    <div className="banking w-[100%] h-screen bg-center bg-cover bg-no-repeat relative" ref={myRef}>
...
and account number.
    ...
    <img src={phone} alt="" srcset="" className={myView ?'m-auto animate-bounce2':'hidden'} />
