  ...
  return (
    <div className="payments bg-white relative h-[100%] pt-[80px]" ref={myRef}>
      <div className="text max-w-[300px] absolute z-[20] top-[110px] right-[55%] ">
        <h2 className="text-[30px] text-[#00D54B] ">Payments</h2>
      ...
      <div className="images bg-white h-[80vh] relative">
        <div className="phone absolute z-[0] h-[40vh] w-[100%] b">
          <img
            ...
            alt=""
            className={
              myView ? "max-h-[50vh] m-auto animate-slideReveal" : "hidden"
            }
            srcset=""
          />
        </div>
        <div className="background ">
          <img
            src={bg}
            alt="payments Pillars "
            className="paymentPillars hidden w-[100vw] bottom-0 absolute z-10 sm:block"
          />
        </div>
      </div>
    </div>
